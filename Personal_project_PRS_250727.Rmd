...
```{r}
hist(geno_pop$SCORESUM, breaks=50, main="PRS Score Distribution for Asthma (1000 Genomes Chr1)", xlab="PRS Score")
```
...
# save as jpeg
jpeg("D:/GoogleDrive/Personal project/PRS-asthma/Images/PRS_scores_by_1000_Genomes_ancestry_group.jpeg", dpi=300)
ggplot(geno_pop, aes(x=super_pop, y=SCORESUM, fill=super_pop)) +
  geom_violin(trim=FALSE) +
  geom_boxplot(width=0.1, fill="white") +
  theme_minimal() +
